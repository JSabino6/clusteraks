...
Para rodar local conectado a um banco, suba um PostgreSQL e configure as variaveis `DB_HOST`, `DB_NAME`, `DB_USER` e `DB_PASSWORD`.

## Subir no AKS

Crie ou use um Azure Container Registry, envie a imagem, troque a imagem no `k8s.yaml` e aplique:
